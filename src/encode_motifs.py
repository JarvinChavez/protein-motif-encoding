...
DATA_PATH = Path(__file__).resolve().parent.parent / "data" / "sample_motif_regions.csv"
OUTPUT_PATH = Path(__file__).resolve().parent.parent / "data" / "encoded_motif_tensor.csv"
MAX_LENGTH = 100
NGRAM_SIZE = 2
